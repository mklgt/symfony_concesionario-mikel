...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder05faf = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer584b0 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa9482 = [
        
    ];

    public function getConnection()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getConnection', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getMetadataFactory', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getExpressionBuilder', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'beginTransaction', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getCache', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getCache();
    }

    public function transactional($func)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'transactional', array('func' => $func), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->transactional($func);
    }

    public function commit()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'commit', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->commit();
    }

    public function rollback()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'rollback', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getClassMetadata', array('className' => $className), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'createQuery', array('dql' => $dql), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'createNamedQuery', array('name' => $name), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'createQueryBuilder', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'flush', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'clear', array('entityName' => $entityName), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->clear($entityName);
    }

    public function close()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'close', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->close();
    }

    public function persist($entity)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'persist', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'remove', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'refresh', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'detach', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'merge', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getRepository', array('entityName' => $entityName), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'contains', array('entity' => $entity), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getEventManager', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getConfiguration', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'isOpen', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getUnitOfWork', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getProxyFactory', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'initializeObject', array('obj' => $obj), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'getFilters', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'isFiltersStateClean', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'hasFilters', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return $this->valueHolder05faf->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer584b0 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder05faf) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder05faf = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder05faf->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, '__get', ['name' => $name], $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        if (isset(self::$publicPropertiesa9482[$name])) {
            return $this->valueHolder05faf->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder05faf;
    ...
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;
    ...
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, '__isset', array('name' => $name), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;
    ...
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, '__unset', array('name' => $name), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;
    ...
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, '__clone', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        $this->valueHolder05faf = clone $this->valueHolder05faf;
    }

    public function __sleep()
    {
        $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, '__sleep', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;

        return array('valueHolder05faf');
    }
    ...
    {
        $this->initializer584b0 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer584b0;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer584b0 && ($this->initializer584b0->__invoke($valueHolder05faf, $this, 'initializeProxy', array(), $this->initializer584b0) || 1) && $this->valueHolder05faf = $valueHolder05faf;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder05faf;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder05faf;
    }
}
